...
struct Simplification<Multiplication<Functions...>, /*var_mult*/ 4> {
  typedef bool_<has_abelian_arithmetic<Multiplication<Functions...> >::value>
  Abelian;
  typedef decltype(SimplifyV<Multiplication>(
      std::declval<tuple<Functions...> >(), Abelian{})) type;

  static type Combine(Multiplication<Functions...> a) {
    SIMPLIFY_INFO("Simplifying multiplication\n");
    return SimplifyV<Multiplication>(a.GetFunctions(), Abelian{});
  }
};
...
struct Simplification<Multiplication<F1, UnaryMinus<F2> >,
                      /*mult_f1_um_f2*/ 2> {
  typedef UnaryMinus<Multiplication<F1, F2> > type;
  static type Combine(Multiplication<F1, UnaryMinus<F2> > m) {
...
template <class F1, class F2>
struct Simplification<Multiplication<UnaryMinus<F1>, F2>, /*mult_um_f1_f2*/ 1> {
  typedef UnaryMinus<Multiplication<F1, F2> > type;
...
struct Simplification<Multiplication<Addition<F1s...>, Addition<F2s...> >,
                      /*mult_add_add*/ 0> {
